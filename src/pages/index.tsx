...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`CargoShare v3`}</title>

        <meta
          name="description"
          content="Experience the future of logistics with CargoShare v3 - Connecting businesses and truck drivers for efficient cargo space utilization, cost-effective shipping, and environmental sustainability."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of logistics with CargoShare v3 - Connecting businesses and truck drivers for efficient cargo space utilization, cost-effective shipping, and environmental sustainability.`}
            </Text>
            <Box
