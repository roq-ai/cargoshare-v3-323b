...
import { getTruckById } from 'apiSdk/trucks';
import { TruckInterface } from 'interfaces/truck';
import { BookingListPage } from 'pages/bookings';
import { RouteListPage } from 'pages/routes';

function TruckViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('truck', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/trucks/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Cargo Space" text={data?.cargo_space} />
