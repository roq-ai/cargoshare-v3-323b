        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Cargo Space Booked" text={data?.cargo_space_booked} />

                <FormListItem label="Booking Cost" text={data?.booking_cost} />
                ...
                {hasAccess('truck', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Truck"
                    text={
                      <Link as={NextLink} href={`/trucks/view/${data?.truck?.id}`}>
                        {data?.truck?.name}
                      </Link>
                    }
                  />
                ...
                {hasAccess('route', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Route"
                    text={
                      <Link as={NextLink} href={`/routes/view/${data?.route?.id}`}>
                        {data?.route?.origin}
                      </Link>
                    }
                  />
