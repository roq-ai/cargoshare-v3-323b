...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bookings', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiBook },
    { name: 'Routes', path: '/routes', entity: 'route', service: AccessServiceEnum.PROJECT, icon: FiMap },
    {
      name: 'Transactions',
      path: '/transactions',
      entity: 'transaction',
    ...
    { name: 'Trucks', path: '/trucks', entity: 'truck', service: AccessServiceEnum.PROJECT, icon: FiTruck },
